        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
              <div class="">
                <div class="x_title">
                  <h2>Statistique de répartition de commandes sur les zones</h2>
...
function drawChart() {
  ...
  ['Zone', 'Nombre de commandes'],
  <?php
foreach($listeZone as $row){
$l=$cmd->nbrZone($row['Zone']);
foreach($l as $x)
$nbr=$x['s'];
  ?>
  ['<?php echo $row['Zone'] ?>',<?php echo $nbr ?>] ,
  <?php } ?>
  ...
  var options = {'title':'Distribution de commandes', 'width':550, 'height':400};
